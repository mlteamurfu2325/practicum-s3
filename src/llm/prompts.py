...
Для вдохновения, вот несколько реальных отзывов из той же рубрики:
{real_reviews}

Требования к отзыву:
1. Естественность языка и стиля, вдохновляясь стилем реальных отзывов
...
6. Сохранение уникальности - не копировать фразы из примеров напрямую
